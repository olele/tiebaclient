.class public Lcom/baidu/android/nebula/cmd/GetApn;
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mErrcode:I

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mContext:Landroid/content/Context;
...
.method public execute(Lcom/baidu/android/nebula/b/a;Lcom/baidu/android/nebula/b/b;)V
    ...
    iput-object v1, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mContext:Landroid/content/Context;

    iget-object v1, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mContext:Landroid/content/Context;
    ...
    iget-object v2, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mContext:Landroid/content/Context;
    ...
    iput v4, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mErrcode:I

    :cond_2
    const/4 v1, 0x0

    iget v2, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mErrcode:I

    if-eq v2, v4, :cond_3

    iput v3, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mErrcode:I

    new-instance v1, Lcom/baidu/android/common/net/ConnectManager;

    iget-object v2, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mContext:Landroid/content/Context;

    invoke-direct {v1, v2}, Lcom/baidu/android/common/net/ConnectManager;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1}, Lcom/baidu/android/common/net/ConnectManager;->getNetType()Ljava/lang/String;
    ...
    iput v1, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mErrcode:I

    :cond_4
    const-string v1, "error"

    iget v3, p0, Lcom/baidu/android/nebula/cmd/GetApn;->mErrcode:I
