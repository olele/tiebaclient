...
# instance fields
.field private final f:Landroid/support/v4/content/l;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Landroid/support/v4/content/k;-><init>(Landroid/support/v4/content/f;)V

    sput-object v0, Landroid/support/v4/content/ModernAsyncTask;->c:Landroid/support/v4/content/k;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/content/g;-><init>(Landroid/support/v4/content/ModernAsyncTask;)V

    iput-object v0, p0, Landroid/support/v4/content/ModernAsyncTask;->f:Landroid/support/v4/content/l;

    .line 127
    new-instance v0, Landroid/support/v4/content/h;

    iget-object v1, p0, Landroid/support/v4/content/ModernAsyncTask;->f:Landroid/support/v4/content/l;

    invoke-direct {v0, p0, v1}, Landroid/support/v4/content/h;-><init>(Landroid/support/v4/content/ModernAsyncTask;Ljava/util/concurrent/Callable;)V
...
.method private d(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 157
    sget-object v0, Landroid/support/v4/content/ModernAsyncTask;->c:Landroid/support/v4/content/k;

    new-instance v1, Landroid/support/v4/content/j;
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v4/content/j;-><init>(Landroid/support/v4/content/ModernAsyncTask;[Ljava/lang/Object;)V
...
.method public final varargs a(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/support/v4/content/ModernAsyncTask;
    ...
    .line 407
    sget-object v0, Landroid/support/v4/content/i;->a:[I
    ...
    .line 422
    iget-object v0, p0, Landroid/support/v4/content/ModernAsyncTask;->f:Landroid/support/v4/content/l;

    iput-object p2, v0, Landroid/support/v4/content/l;->b:[Ljava/lang/Object;
